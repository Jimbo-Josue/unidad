...
require 'drivers/usuarios.php';
require 'drivers/contactos.php';
require 'drivers/room.php';
require 'drivers/message.php';
require 'drivers/groups.php';
...
$recursos_existentes = array('contactos', 'usuarios', 'room', 'groups', 'message');
